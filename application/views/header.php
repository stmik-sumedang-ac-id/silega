	<div class="navbar navbar-legalisir navbar-fixed-top" role="navigation" >
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="margin-top:0px ;padding-top:0px;margin-bottom: 0px;padding-bottom: 0px;" href="<?php echo base_url()?>"><img src="<?php echo base_url('images/stmik-small.png')?>" style="height:50px;margin: 0px;padding: 0px" /> Sistem Informasi Legalisasi Dokumen</a>
        </div>
     ...
     <!-- <form class="navbar-form-navbar-rihgt" action="<?php echo base_url('authenticate/forgotpass')?>" method="post"> -->
            <div class="form-group">
              <input type="text" placeholder="Nomor ijazah" name="u" class="form-control">
            </div>
            <div class="form-group">
